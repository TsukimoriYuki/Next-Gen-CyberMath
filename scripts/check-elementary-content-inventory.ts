...
if (issues.length) {
  ...
  console.log(
    `elementary content inventory QA passed: ${inventory.totals.unitCount} units, ${inventory.totals.lessonCount} lessons, ${inventory.totals.problemCount} problems, 2 assets; high school 1348 / combined 1372`,
  );
}
