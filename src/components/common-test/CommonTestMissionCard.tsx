...
export function CommonTestMissionCard({ mission, index }: { mission: DailyMission; index: number }) {
  ...
  return (
    ...
    >
      {/* Index badge */}
      <div
        className="absolute right-4 top-4 flex h-6 w-6 items-center justify-center rounded-full font-mono text-[10px] font-bold text-slate-400 ring-1 ring-slate-200"
      >
