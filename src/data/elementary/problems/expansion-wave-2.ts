...
const LESSON_SEEDS: readonly LessonProblemSeed[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { title: "二つのたしかめ", prompt: "3210−985＝2225をたしかめるやり方はどれですか。", labels: ["2225＋985を計算する", "3210−2225を計算する", "2225−985を計算する", "3210＋985を計算する"], correct: [0, 1], detailed: "ちがいとひいた数をたすやり方、もとの数からちがいをひくやり方でたしかめられます。" },
    ],
    numerics: [
  ...
  },
  {
    ...
    choices: [
      { title: "合うたんい", prompt: "町から遠くの町までの道のりを表すのに合うたんいはどれですか。", labels: ["km", "mm", "g", "秒"], correct: [0], detailed: "町から遠くの町までの長い道のりにはkmが合います。" },
  ...
  },
  {
    ...
    choices: [
      ...
      { title: "正三角形のきまり", prompt: "3本のへんがすべて同じ三角形について正しいものはどれですか。", labels: ["正三角形である", "3本のへんが同じ長さ", "三角形ではない", "へんが4本ある"], correct: [0, 1], detailed: "3本のへんがすべて同じ長さの三角形を正三角形といいます。" },
    ],
    numerics: [
  ...
  },
  {
    ...
    choices: [
      ...
      { title: "正しいせつめい", prompt: "円について正しいものはどれですか。", labels: ["半けいはどこでも同じ長さ", "直けいは半けい2本分", "中心を通らない線も直けい", "円と球は同じ立体"], correct: [0, 1], detailed: "半けいは同じ長さで、直けいは中心を通る半けい2本分です。" },
    ],
    numerics: [
  ...
  },
  {
    ...
    choices: [
      ...
      { title: "二つの読み取り", prompt: "図から正しく読めることはどれですか。", labels: ["おにごっこは12人", "読書は6人", "全員が同じ遊びをすき", "すきな理由まで分かる"], correct: [0, 1], detailed: "ぼうの高さから人数は読めますが、理由までは分かりません。" },
    ],
    numerics: [
